...
private:
    ...
    std::deque<short> patientHealedDays; // Stock le nombre de jours que le patient passe dans l'hopital en étant soigné
    ...
    const short nbDaysBeforeRelease = 5; // Nombre de jours que le patient passe dans l'hopital en étant soigné avant d'être relaché
};
